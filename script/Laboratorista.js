...
function redireccionar(num) {
    switch(num){
        case 1:
            window.location.href = "../html/registrar/RegistrarLaboratorista.html";
            break;
        case 2:
        	if(listaMatriculas.length>=1){
            	var valorCampoTexto = listaMatriculas[0];
        		window.location.href = "../html/modificar/ModificarLaboratorista.html?valor=" + encodeURIComponent(valorCampoTexto);
        	}else{
        		window.location.href = "../html/modificar/ModificarLaboratorista.html";
        	}
            break;
    }
}
...
function eliminarSolicitante(id, callback) {
    ...
    xhr.send("idLaboratorista=" + encodeURIComponent(id) + "&elegir=" + encodeURIComponent("eliminar_datos"));
}
...
document.getElementById("FormAgregar").addEventListener("submit", function(event) {
    ...
    var idLaboratorista = document.getElementById("idLaboratoristaA").value;
...
function detectarPatron() {
    var contenido = document.getElementById("idLaboratoristaA").value;
